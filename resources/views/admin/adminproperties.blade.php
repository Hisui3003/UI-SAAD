        ...
        <div class=" bg-white py-5 px-5">
            <div class="flex justify-between items-center">
                ...
                <div class="flex-1 flex justify-center space-x-6">
                    ...
                    <a href="{{ route('admin.adminproperties') }}" class="text-black hover:text-gray-300 uppercase font-semibold underline">Properties</a>
                </div>
                        ...
                        <div class="overflow-x-auto my-3 bg-white rounded-lg max-h-[500px] relative">
                            <table class="table-auto w-full border-transparent">
                                <thead class="sticky top-0 bg-white">
                                        <tr>
                                            <th class="px-4 py-2 border-b border-r bg-gray-300" style="width: 35%;">Place Name</th>
                                            <th class="px-4 py-2 border-b border-r bg-gray-300" style="width: 35%;">Owner</th>
                                            <th class="px-4 py-2 border-b border-r bg-gray-300" style="width: 35%;">Place Name</th>
